...
with DAG(
    ...
    def _branch_p1_01_processing_to_master_table_02(**ctx):
        ...
        return 'p1_01_processing_to_master_table_02' if eval("entrenar==True", {}, params) else 'p2_03_test_train_ml_project'
    ...
    # Etapa 8
    p2_03_test_train_ml_project = run_rocket_operator("p2_03_test_train_ml_project", "P2_03-test-train-ml-project", "/home/haa/01-pipelines/p2-modelling/01-via/02-via-desvio-travesia/01-train/03-test-train-ml-project", "XS", "none_failed")
    ...
    check_p1_01_processing_to_master_table_02 >> p2_03_test_train_ml_project  # si no: saltar a 'P2_03-test-train-ml-project'
