...
with DAG(
    ...
    # Etapa 6
    def _branch_p2_01_pipeline_training(**ctx):
        params = ctx.get('params', {})
        return 'p2_01_pipeline_training' if eval("entrenar == True", {}, params) else 'p2_02_feature_quantiles_matrix'
    check_p2_01_pipeline_training = BranchPythonOperator(
        task_id="check_p2_01_pipeline_training",
        python_callable=_branch_p2_01_pipeline_training,
        dag=dag,
    )
    ...
    check_p2_01_pipeline_training >> p2_01_pipeline_training
    ...
    # Etapa 12
    p2_02_feature_quantiles_matrix = run_rocket_operator("p2_02_feature_quantiles_matrix", "P2_02-feature-quantiles-matrix", "/home/haa/01-pipelines/p2-modelling/01-via/02-via-desvio-travesia/02-prediction/02-feature-quantiles-matrix", "XS", "none_failed")
    # Dependencias
    p0_01_raw_to_interim_elementos_auscultaciones >> p0_02_raw_to_interim_averias
    p0_02_raw_to_interim_averias >> [p1_00_extratables_ausc_geom, p1_01_extratables_ausc_ultra, p1_02_extratables_carrilcruzamiento, p1_03_extratables_carrilintermedio, p1_04_extratables_contracarril, p1_05_extratables_corazon, p1_06_extratables_marmita, p1_07_extratables_semicambio]
    [p1_00_extratables_ausc_geom, p1_01_extratables_ausc_ultra, p1_02_extratables_carrilcruzamiento, p1_03_extratables_carrilintermedio, p1_04_extratables_contracarril, p1_05_extratables_corazon, p1_06_extratables_marmita, p1_07_extratables_semicambio] >> p1_01_processing_to_master_table_01
    p1_01_processing_to_master_table_01 >> p1_01_processing_to_master_table_02
    p1_01_processing_to_master_table_02 >> check_p2_01_pipeline_training
    ...
    check_p2_01_pipeline_training >> p2_02_feature_quantiles_matrix  # si no: saltar a 'P2_02-feature-quantiles-matrix'
