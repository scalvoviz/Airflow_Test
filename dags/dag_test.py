...
with DAG(
    ...
    def _branch_p1_01_processing_to_master_table_01(**ctx):
        ...
        return 'p1_01_processing_to_master_table_01' if eval("entrenar == True", {}, params) else 'p2_02_feature_quantiles_matrix'
    ...
    [p1_01_extratables_ausc_ultra, p1_02_extratables_carrilcruzamiento, p1_03_extratables_carrilintermedio, p1_04_extratables_contracarril, p1_05_extratables_corazon, p1_06_extratables_marmita] >> p1_07_extratables_semicambio
    ...
    check_p1_01_processing_to_master_table_01 >> p2_02_feature_quantiles_matrix  # si no: saltar a 'P2_02-feature-quantiles-matrix'
