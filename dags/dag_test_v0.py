...
with DAG(
    ...
    # Etapa 10
    def _branch_p2_06_aux_overwrite_model(**ctx):
        params = ctx.get('params', {})
        return 'p2_06_aux_overwrite_model' if eval("entrenar == True", {}, params) else 'p2_01_prediction'
    check_p2_06_aux_overwrite_model = BranchPythonOperator(
        task_id="check_p2_06_aux_overwrite_model",
        python_callable=_branch_p2_06_aux_overwrite_model,
        dag=dag,
    )
    ...
    check_p2_06_aux_overwrite_model >> p2_06_aux_overwrite_model
    ...
    p2_05_model_comparison >> check_p2_06_aux_overwrite_model
    ...
    check_p2_06_aux_overwrite_model >> p2_01_prediction  # si no: saltar a 'P2_01-prediction'
