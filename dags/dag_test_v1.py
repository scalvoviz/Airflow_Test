...
with DAG(
    ...
    # Etapa 8
    def _branch_p2_03_test_train_ml_project(**ctx):
        params = ctx.get('params', {})
        return 'p2_03_test_train_ml_project' if eval("modelar == True", {}, params) else 'p2_01_prediction'
    check_p2_03_test_train_ml_project = BranchPythonOperator(
        task_id="check_p2_03_test_train_ml_project",
        python_callable=_branch_p2_03_test_train_ml_project,
        dag=dag,
    )
    ...
    check_p2_03_test_train_ml_project >> p2_03_test_train_ml_project
    ...
    # Etapa 12
    p2_01_prediction = run_rocket_operator("p2_01_prediction", "P2_01-prediction", "/home/haa/01-pipelines/p2-modelling/01-via/02-via-desvio-travesia/02-prediction/01-prediction", "XS", "none_failed")
    ...
    [p1_00_extratables_ausc_geom, p1_01_extratables_ausc_ultra, p1_02_extratables_carrilcruzamiento, p1_03_extratables_carrilintermedio, p1_04_extratables_contracarril, p1_05_extratables_corazon, p1_06_extratables_marmita, p1_07_extratables_semicambio] >> p1_00_weather_matching
    ...
    p2_01_pipeline_training >> check_p2_03_test_train_ml_project
    ...
    check_p2_03_test_train_ml_project >> p2_01_prediction  # si no: saltar a 'P2_01-prediction'
